...
class RecordController(Controller):
    ...
    async def create_record(
        ...
        request: Request,
        record_service: FromDishka[RecordUseCases],
    ) -> SuccessResponse:
        """Create a new daily record."""
        user_id = request.user.id
        result = await record_service.create(data=data, user_id=user_id)
    ...
    async def get_record(
        ...
        user_id = request.user.id
        result = await record_service.get(record_id=record_id, user_id=user_id)
    ...
    async def get_records(
        ...
        user_id = request.user.id
        result = await record_service.get_many(target_date=date, user_id=user_id)
    ...
    async def append_to_record(
        ...
        user_id = request.user.id
        result = await record_service.append(record_id=record_id, data=data, user_id=user_id)
    ...
    async def update_record(
        ...
        user_id = request.user.id
        result = await record_service.update(record_id=record_id, data=data, user_id=user_id)
    ...
    async def get_record_with_task(
        self, record_service: FromDishka[RecordUseCases], record_id: int, request: Request
    ) -> SuccessResponse:
        """Get record with external task information."""
        user_id = request.user.id
        result = await record_service.get_with_task(record_id=record_id, user_id=user_id)
    ...
    async def link_external_task(
        ...
        user_id = request.user.id
        result = await record_service.link_task(
    ...
    async def delete_record(
        ...
        """Delete a record."""
        user_id = request.user.id
        await record_service.delete(record_id=record_id, user_id=user_id)
    ...
    async def approve_record(
        ...
        user_id = request.user.id
        result = await record_service.approve(record_id=record_id, user_id=user_id)
