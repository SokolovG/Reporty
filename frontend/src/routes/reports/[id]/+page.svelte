<script lang="ts">
    ...
    var parsedContent = parseContent(report.content);
</script>
...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <!-- Header Badge -->
        <div
            class="px-6 py-4 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-200 rounded-t-xl"
        >
            <div class="flex items-center gap-2">
                ...
                >
                <span
                    class="px-2 py-1 text-xs bg-amber-100 text-amber-700 rounded-full"
                >
            ...
            <div class="prose prose-gray max-w-none">
                {#each parsedContent as item}
                    ...
                    {:else if item.type === "task"}
                        <div
                            class="mb-4 p-4 bg-gray-50 rounded-lg border-l-4 border-amber-400"
                        >
                    ...
                    {:else if item.type === "summary"}
                        <div
                            class="mt-8 p-4 bg-green-50 rounded-lg border border-green-200"
                        >
                            <p
                                class="text-green-800 font-semibold flex items-center gap-2"
                            >
                                <svg
                                    class="w-5 h-5"
                                    fill="currentColor"
