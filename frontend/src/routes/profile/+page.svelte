<script lang="ts">
    ...
    const openTasks =
        records?.filter((task) => task.status === "OPEN")?.length || 0;
    const closedTasks =
        records?.filter((task) => task.status === "CLOSED")?.length || 0;
...
<div
    class="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 min-h-screen"
>
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                >
                    <div
                        class="bg-gradient-to-r from-amber-600 to-orange-600 px-6 py-4"
                    >
                        ...
                        {#if !isEditing}
                            <div class="space-y-4">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center text-white text-xl font-bold"
                                    >
                                        {user.name
                                            ? user.name
                                                  .split(" ")
                        ...
                        {#if !isEditingAI}
                            <div class="space-y-4">
                                ...
                                >
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">
                                            Automatically process new records
                                            with AI
                                        </p>
                                    </div>
                                    <span
                                        class="px-2 py-1 text-xs rounded-full {user.aiAutoProcess
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-gray-900 text-sm bg-gray-50 p-3 rounded-lg mt-1"
                                    >
                                        {user.customPrompt ||
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        This prompt will be combined with the
                                        system prompt to personalize AI
            ...
            <div class="space-y-6">
                ...
                >
                    <div
                        class="bg-gradient-to-r from-stone-600 to-amber-700 px-6 py-4"
                    >
                        <h2
                            class="text-xl font-semibold text-white flex items-center gap-2"
                        >
                ...
                >
                    <div
                        class="bg-gradient-to-r from-red-600 to-rose-600 px-6 py-4"
                    >
                        <h2
                            class="text-xl font-semibold text-white flex items-center gap-2"
                        >
